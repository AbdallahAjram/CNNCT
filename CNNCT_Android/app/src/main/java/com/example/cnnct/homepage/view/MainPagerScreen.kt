...
import com.example.cnnct.calls.view.CallsScreen
import com.example.cnnct.groups.view.GroupScreen
import com.example.cnnct.settings.view.SettingsScreen
...
fun MainPagerScreen(
    ...
    callsViewModel: com.example.cnnct.calls.viewmodel.CallsViewModel = androidx.lifecycle.viewmodel.compose.viewModel(factory = com.example.cnnct.calls.viewmodel.CallsViewModel.Factory)
) {
            ...
            HorizontalPager(state = pagerState, modifier = Modifier.fillMaxSize()) { page ->
                when (page) {
                    ...
                    3 -> SettingsScreen(
                        ...
                        onNavigate = { dest ->
                           when(dest) {
                               "Account" -> context.startActivity(Intent(context, com.example.cnnct.settings.view.AccountActivity::class.java))
                               "Privacy" -> context.startActivity(Intent(context, com.example.cnnct.settings.view.PrivacySettingsActivity::class.java))
                               "Notifications" -> context.startActivity(Intent(context, com.example.cnnct.notifications.view.NotificationSettingsActivity::class.java))
                               "Archived Chats" -> context.startActivity(Intent(context, com.example.cnnct.settings.view.ArchiveSettingsActivity::class.java))
                               "Blocked Accounts" -> context.startActivity(Intent(context, com.example.cnnct.settings.view.BlockedSettingsActivity::class.java))
                               else -> {}
                           }
                        }
                    ) 
