package com.abdallah.cnnct.auth.viewmodel
...
import com.abdallah.cnnct.auth.view.LoginForm
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                if (idToken != null) {
                    ...
                    android.util.Log.e("GOOGLE_AUTH", "Google sign-in failed: No ID token")
                    Toast.makeText(this, "Google sign-in failed: No ID token", Toast.LENGTH_SHORT).show()
                }
            } catch (e: com.google.android.gms.common.api.ApiException) {
                android.util.Log.e("GOOGLE_AUTH", "Google sign-in failed", e)
                android.util.Log.e("GOOGLE_AUTH", "Error code: " + e.statusCode)
                System.out.println("GOOGLE_AUTH: StatusCode=" + e.statusCode)
                Toast.makeText(this, "Google sign-in failed: Code " + e.statusCode, Toast.LENGTH_SHORT).show()
            } catch (e: Exception) {
                android.util.Log.e("GOOGLE_AUTH", "Google sign-in failed (Generic)", e)
