package com.abdallah.cnnct.calls
...
import com.abdallah.cnnct.notifications.ForegroundTracker
import com.abdallah.cnnct.notifications.MuteStore
import com.abdallah.cnnct.notifications.NotificationHelper
import com.abdallah.cnnct.notifications.NotificationsStore
import com.abdallah.cnnct.notifications.SettingsCache
import com.abdallah.cnnct.notifications.TokenRegistrar
        ...
        when (type) {
            ...
            "message", "chat" -> {
                ...
                val open = android.app.PendingIntent.getActivity(
                    ...
                    Intent(this, com.abdallah.cnnct.homepage.view.HomeActivity::class.java)
