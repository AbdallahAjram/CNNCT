package com.example.cnnct.groups.repository
...
class GroupRepository(
    ...
    fun observeUserGroups(): kotlinx.coroutines.flow.Flow<List<com.example.cnnct.homepage.model.ChatSummary>> = kotlinx.coroutines.flow.callbackFlow {
        val uid = me()
        val reg = db.collection("chats")
            ...
            .addSnapshotListener { snap, err ->
                ...
                val groups = snap?.documents?.mapNotNull { doc ->
                    doc.toObject(com.example.cnnct.homepage.model.ChatSummary::class.java)?.apply { id = doc.id }
