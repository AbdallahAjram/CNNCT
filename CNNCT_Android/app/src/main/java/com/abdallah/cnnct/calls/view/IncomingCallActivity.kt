...
import com.abdallah.cnnct.calls.PushService

class IncomingCallActivity : ComponentActivity() {
    
    // Use delegation to get ViewModel with Factory
    private val viewModel: com.abdallah.cnnct.calls.viewmodel.IncomingCallViewModel by viewModels {
        com.abdallah.cnnct.calls.viewmodel.IncomingCallViewModel.Factory
    }
